...
//        load("monster_sheet.png", Texture.class);
    ...
    // Combat cues, generated by tools/generate_combat_sounds.py.
    public final static String FIREBALL_LAUNCH_SOUND = "sounds/fireball_launch.wav";
    public final static String FIREBALL_IMPACT_SOUND = "sounds/fireball_impact.wav";
    public final static String MONSTER_TOKEN_HIT_SOUND = "sounds/monster_token_hit.wav";
    public final static String MONSTER_HEALTH_LEAVE_SOUND = "sounds/monster_health_leave.wav";
    public final static String MONSTER_HEALTH_TEAR_SOUND = "sounds/monster_health_tear.wav";
