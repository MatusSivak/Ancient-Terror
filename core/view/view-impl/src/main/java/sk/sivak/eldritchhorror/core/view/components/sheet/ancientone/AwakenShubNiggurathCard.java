...
public class AwakenShubNiggurathCard extends VisTable implements AncientOneCard{
    ...
    public AwakenShubNiggurathCard() {
    ...
    public void init(AncientOneInfo ancientOneInfo) {
        ...
        Image splashImage = new Image(CustomAssetManager.getTexture("ancient_one/SHUB_NIGGURATH_AWAKEN.png"));
    ...
    private Table createEndGameTable(AncientOneInfo ancientOneInfo) {
        ...
        table.add(winValue).padTop(5).align(Align.left).width(360).padLeft(5);
    ...
    private Table createTopLeftPart(AncientOneInfo ancientOneInfo) {
        ...
        table.add(createPowerTable()).padTop(5).align(Align.left);
        return table;
    }
    ...
    private Table createPowerTable() {
        ...
        Label powerLabel = createTextLabel("Monsters:");
