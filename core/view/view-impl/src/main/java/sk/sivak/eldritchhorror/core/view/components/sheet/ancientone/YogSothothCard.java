...
public class YogSothothCard extends VisTable implements AncientOneCard{
    ...
    public void init(AncientOneInfo ancientOneInfo) {
        ...
        Image splashImage = new Image(CustomAssetManager.getTexture("ancient_one/YOG_SOTHOTH.png"));
        splashImage.setScaling(Scaling.fit);
        add(splashImage).colspan(2).height(225).row();
