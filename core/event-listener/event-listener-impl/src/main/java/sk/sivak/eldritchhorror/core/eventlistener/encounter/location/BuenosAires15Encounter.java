...
public class BuenosAires15Encounter extends AbstractLocationEncounter{

    public BuenosAires15Encounter() {
        super(15, LocationEncounter.LocationEncounterType.BUENOS_AIRES);
    }
