...
import sk.sivak.eldritchhorror.core.constants.asset.PrivateInvestigatorAsset;
 ...
 * @author msivak
 */
public class PrivateInvestigatorListener extends AbstractAssetListener<PrivateInvestigatorAsset> {

    private static final Logger logger = LogManager.getLogger(PrivateInvestigatorListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        public RegisterUsableAssetListener() {
            super(PrivateInvestigatorListener.this);
        }
