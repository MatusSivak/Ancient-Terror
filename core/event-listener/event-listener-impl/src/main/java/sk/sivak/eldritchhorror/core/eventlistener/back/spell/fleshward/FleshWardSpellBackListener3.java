...
public class FleshWardSpellBackListener3 extends AbstractSpellBackListener {

    public FleshWardSpellBackListener3(SpellInfo spellInfo) {
        super(spellInfo);
    }
    ...
    private void on0() {
        TypewriterUtils.confirmInfos("[#BAD]That investigator gains Illness Condition.[]").subscribe(() -> {
