...
public class DetainedConditionBackListener4 extends AbstractConditionBackListener {

    public DetainedConditionBackListener4(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
    ...
    private void onCanNotSpendClue() {
        TypewriterUtils.displayTestConditionButton(Stat.STRENGTH, -1, getConditionInfo(), this::onSuccess, this::onFail);
    }
    ...
    private void onFail() {
        TypewriterUtils.confirmInfos(
                ...
                "[#BAD]Gain an Internal Injury Condition[]",
    ...
    private void onTestChoice() {
        ...
        ServicePlatform.get().getTestService().test(Stat.STRENGTH, -1, JUST_ONE, createConditionFlavorRequest()).subscribe(
                testData -> {
