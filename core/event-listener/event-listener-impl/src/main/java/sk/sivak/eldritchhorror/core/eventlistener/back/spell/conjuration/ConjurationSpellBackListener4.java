...
public class ConjurationSpellBackListener4 extends AbstractSpellBackListener {

    public ConjurationSpellBackListener4(SpellInfo spellInfo) {
        super(spellInfo);
    }
    ...
    private void on0() {
        new DiscardThisSpellUnless(getSpellInfo(), getActiveInvestigatorId()).lose3Health();
    }
