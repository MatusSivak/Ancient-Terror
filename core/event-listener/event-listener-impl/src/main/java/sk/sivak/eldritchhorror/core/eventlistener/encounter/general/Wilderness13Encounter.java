...
public class Wilderness13Encounter extends AbstractGeneralEncounter {

    public Wilderness13Encounter() {
        super(13, LocationType.WILDERNESS);
    }

    @Override
    protected void execute() {
        TypewriterUtils.displayTestButton(Stat.STRENGTH, -1, this::onSuccess, this::onFail);
    }
