...
public class InternalInjuryConditionBackListener3 extends AbstractConditionBackListener {

    public InternalInjuryConditionBackListener3(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
