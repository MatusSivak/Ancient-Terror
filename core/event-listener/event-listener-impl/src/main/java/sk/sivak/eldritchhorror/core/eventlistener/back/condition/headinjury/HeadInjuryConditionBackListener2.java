...
public class HeadInjuryConditionBackListener2 extends AbstractConditionBackListener {

    public HeadInjuryConditionBackListener2(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
