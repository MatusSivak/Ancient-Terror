...
import sk.sivak.eldritchhorror.core.constants.asset.ExpeditionMapAsset;
 ...
 * @author msivak
 */
public class ExpeditionMapListener extends AbstractAssetListener<ExpeditionMapAsset> {

    private static final Logger logger = LogManager.getLogger(ExpeditionMapListener.class);
    ...
    private class AddOneToDieResultListener extends AbstractAssetEventListener<AddOneToDieResultData> {
        ...
        public AddOneToDieResultListener() {
            super(ExpeditionMapListener.this);
        }
