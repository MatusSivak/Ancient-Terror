package sk.sivak.eldritchhorror.core.eventlistener.back.condition.internalinjury;
...
public class InternalInjuryConditionBackListener4 extends AbstractConditionBackListener {

    public InternalInjuryConditionBackListener4(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
    ...
    private void discardThisCard() {
        ...
        showCardRequest.setTitle("Discard Internal Injury Condition");
