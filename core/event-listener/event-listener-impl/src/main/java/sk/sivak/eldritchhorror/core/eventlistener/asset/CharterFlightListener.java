 ...
 * @author msivak
 */
public class CharterFlightListener extends AbstractAssetListener<CharterFlightAsset> {

    private static final Logger logger = LogManager.getLogger(CharterFlightListener.class);
    ...
    protected void register() {
        ServicePlatform.get().getService().addEventCommand((input) -> {
            ...
            showCardRequest.setTitle("Move up to 2 spaces");
    ...
    private void onAnswer(ShowCardResponse showCardResponse, Object input) {
        ...
        ServicePlatform.get().getBasicActionService().moveSpaces(new TravelData(true), 2);
