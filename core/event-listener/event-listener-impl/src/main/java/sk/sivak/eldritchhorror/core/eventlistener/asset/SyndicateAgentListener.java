...
import sk.sivak.eldritchhorror.core.constants.asset.SyndicateAgentAsset;
 ...
 * @author msivak
 */
public class SyndicateAgentListener extends AbstractAssetListener<SyndicateAgentAsset> {

    private static final Logger logger = LogManager.getLogger(SyndicateAgentListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        public RegisterUsableAssetListener() {
            super(SyndicateAgentListener.this);
        }
