...
public class SanFrancisco9Encounter extends AbstractLocationEncounter{

    public SanFrancisco9Encounter() {
        super(9, LocationEncounter.LocationEncounterType.SAN_FRANCISCO);
    }
