...
import sk.sivak.eldritchhorror.core.constants.asset.BullWhipAsset;
 ...
 * @author msivak
 */
public class BullWhipListener extends AbstractAssetListener<BullWhipAsset> {

    private static final Logger logger = LogManager.getLogger(BullWhipListener.class);
