...
import sk.sivak.eldritchhorror.core.constants.asset.ArcaneScholarAsset;
 ...
 * @author msivak
 */
public class ArcaneScholarListener extends AbstractAssetListener<ArcaneScholarAsset> {

    private static final Logger logger = LogManager.getLogger(ArcaneScholarListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        public RegisterUsableAssetListener() {
            super(ArcaneScholarListener.this);
        }
