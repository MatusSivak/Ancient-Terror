...
public class DetainedConditionBackListener1 extends AbstractConditionBackListener {

    public DetainedConditionBackListener1(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
    ...
    private void onCanNotSpendClue() {
        TypewriterUtils.displayTestConditionButton(Stat.OBSERVATION, -1, getConditionInfo(), this::onSuccess, this::onFail);
    }
    ...
    private void onTestChoice() {
        ...
        ServicePlatform.get().getTestService().test(Stat.OBSERVATION, -1, JUST_ONE, createConditionFlavorRequest()).subscribe(
                testData -> {
