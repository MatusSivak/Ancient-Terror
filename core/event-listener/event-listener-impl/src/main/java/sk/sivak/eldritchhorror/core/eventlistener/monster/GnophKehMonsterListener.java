...
public class GnophKehMonsterListener extends AbstractMonsterListener {
    ...
    public void register(MonsterInfo monsterInfo) {
        ...
        ServicePlatform.get().getMonsterService().moveMonster(monsterInfo, LocationId.THE_HIMALAYAS);
