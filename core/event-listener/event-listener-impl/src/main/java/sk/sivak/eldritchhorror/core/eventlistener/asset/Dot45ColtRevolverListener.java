...
import sk.sivak.eldritchhorror.core.constants.asset.Dot45ColtRevolverAsset;
 ...
 * @author msivak
 */
public class Dot45ColtRevolverListener extends AbstractAssetListener<Dot45ColtRevolverAsset> {

    private static final Logger logger = LogManager.getLogger(Dot45ColtRevolverListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        public RegisterUsableAssetListener() {
            super(Dot45ColtRevolverListener.this);
        }
        ...
        protected Runnable getEventAction(TestData input) {
            return () -> {
                ...
                UsableAsset usableAsset = addUsableAsset(input, getAssetInfo(), 3);
        ...
        private Action0 getOnUseAction(TestData input) {
            return () -> {
                ...
                request.setTitle(".45 Colt Revolver used");
