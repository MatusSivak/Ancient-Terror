...
public class VoidBetweenWorldsListener extends AbstractMysteryListener implements EventListener<AvailableEncounters>  {

    private AvailableEncounters availableEncounters;

    private int progress;

    public VoidBetweenWorldsListener(MysteryCardInfo mysteryCardInfo) {
    ...
    public void onNotify(AvailableEncounters eventData) {
        ...
        encounter.setEncounterType(EncounterType.VOID_BETWEEN_WORLDS);
