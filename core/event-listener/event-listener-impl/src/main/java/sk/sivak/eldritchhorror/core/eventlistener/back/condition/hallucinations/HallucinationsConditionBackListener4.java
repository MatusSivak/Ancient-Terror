...
public class HallucinationsConditionBackListener4 extends AbstractConditionBackListener {

    public HallucinationsConditionBackListener4(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
    ...
    protected void execute() {
        TypewriterUtils.confirmInfos(
                "[#BAD]Gain a Lost in Time and Space Condition[]",
