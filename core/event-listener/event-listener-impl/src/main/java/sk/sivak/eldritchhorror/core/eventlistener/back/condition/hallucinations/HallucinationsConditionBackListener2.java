...
public class HallucinationsConditionBackListener2 extends AbstractConditionBackListener {

    public HallucinationsConditionBackListener2(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
