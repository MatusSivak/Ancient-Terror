...
import sk.sivak.eldritchhorror.core.constants.asset.LuckyRingAsset;
 ...
 * @author msivak
 */
public class LuckyRingListener extends AbstractAssetListener<LuckyRingAsset> {

    private static final Logger logger = LogManager.getLogger(LuckyRingListener.class);
