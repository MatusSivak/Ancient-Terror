...
import sk.sivak.eldritchhorror.core.constants.asset.HiredMuscleAsset;
 ...
 * @author msivak
 */
public class HiredMuscleListener extends AbstractAssetListener<HiredMuscleAsset> {

    private static final Logger logger = LogManager.getLogger(HiredMuscleListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        public RegisterUsableAssetListener() {
            super(HiredMuscleListener.this);
        }
