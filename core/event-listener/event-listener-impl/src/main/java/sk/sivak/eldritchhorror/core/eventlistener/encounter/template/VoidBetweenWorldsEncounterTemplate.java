...
public class VoidBetweenWorldsEncounterTemplate extends ComplexEncounterTemplate {

    public VoidBetweenWorldsEncounterTemplate(EncounterTextBuilder textBuilder, Stat testStat, int modifier, EncounterTemplate passTemplate, EncounterTemplate failTemplate) {
