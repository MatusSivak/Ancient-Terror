...
import sk.sivak.eldritchhorror.core.constants.asset.ConsecrationAsset;
 ...
 * @author msivak
 */
public class ConsecrationListener extends AbstractAssetListener<ConsecrationAsset> {

    private static final Logger logger = LogManager.getLogger(ConsecrationListener.class);
    ...
    protected void register() {
        ServicePlatform.get().getService().addEventCommand((input) -> {
            ...
            showCardRequest.setTitle("Gain Boon Condition");
