...
public class TheKeyAndTheGateEncounterTemplate extends ComplexEncounterTemplate {

    public TheKeyAndTheGateEncounterTemplate(EncounterTextBuilder textBuilder, Stat testStat, int modifier, EncounterTemplate passTemplate, EncounterTemplate failTemplate) {
