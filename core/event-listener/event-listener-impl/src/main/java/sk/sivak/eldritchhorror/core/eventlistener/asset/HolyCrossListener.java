...
import sk.sivak.eldritchhorror.core.constants.asset.HolyCrossAsset;
 ...
 * @author msivak
 */
public class HolyCrossListener extends AbstractAssetListener<HolyCrossAsset> {

    private static final Logger logger = LogManager.getLogger(HolyCrossListener.class);
