...
import sk.sivak.eldritchhorror.core.constants.asset.Dot18DerringerAsset;
 ...
 * @author msivak
 */
public class Dot18DerringerListener extends AbstractAssetListener<Dot18DerringerAsset> {

    private static final Logger logger = LogManager.getLogger(Dot18DerringerListener.class);
    ...
    private class AddOneToDieResultListener extends AbstractAssetEventListener<AddOneToDieResultData> {
        ...
        public AddOneToDieResultListener() {
            super(Dot18DerringerListener.this);
        }
        ...
        protected Runnable getEventAction(AddOneToDieResultData input) {
            return () -> {
                ...
                if (testData.getStat() != Stat.STRENGTH) {
                    return;
                }
