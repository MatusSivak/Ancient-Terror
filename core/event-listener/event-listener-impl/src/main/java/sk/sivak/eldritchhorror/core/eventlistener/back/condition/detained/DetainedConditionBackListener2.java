...
public class DetainedConditionBackListener2 extends AbstractConditionBackListener {

    public DetainedConditionBackListener2(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
    ...
    private void onFail() {
        ServicePlatform.get().getEncounterService().typeFlavor("They beat you and leave you to die.");
    ...
    private void onTestChoice() {
        ...
        ServicePlatform.get().getTestService().test(Stat.INFLUENCE, -1, JUST_ONE, createConditionFlavorRequest()).subscribe(
                testData -> {
