...
public class HeadInjuryConditionBackListener4 extends AbstractConditionBackListener {

    public HeadInjuryConditionBackListener4(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
