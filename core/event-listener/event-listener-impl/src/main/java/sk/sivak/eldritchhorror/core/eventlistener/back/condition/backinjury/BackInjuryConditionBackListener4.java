...
public class BackInjuryConditionBackListener4 extends AbstractConditionBackListener {

    public BackInjuryConditionBackListener4(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
    ...
    protected void execute() {
        TypewriterUtils.confirmInfos(
                "[#BAD]Discard one Item possession[]").subscribe(() -> {
