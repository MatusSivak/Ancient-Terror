...
public class ResearchWilderness3Encounter extends AbstractAzathothResearchEncounter {
    ...
    protected void execute() {
        new InfoFlavorTemplate(getTextBuilder(), () -> {
            ...
            ServicePlatform.get().getService().release();
                ...
                () -> ServicePlatform.get().getTokenService().loseSanity(6)
        ).withoutFailFlavor().withResearchFlavor()).execute();
    }
}
