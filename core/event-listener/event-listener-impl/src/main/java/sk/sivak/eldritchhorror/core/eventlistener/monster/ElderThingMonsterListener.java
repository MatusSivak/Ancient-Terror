...
public class ElderThingMonsterListener extends AbstractMonsterListener {
    ...
    public void register(MonsterInfo monsterInfo) {
        ...
        ServicePlatform.get().getMonsterService().moveMonster(monsterInfo, LocationId.ANTARCTICA);
