...
public class LegInjuryListener extends AbstractConditionListener<LegInjuryCondition> {
    ...
    protected void register() {
        ...
        reckoningListener = new ConditionReckoningListener(LegInjuryListener.this);
