...
import sk.sivak.eldritchhorror.core.constants.asset.EnchantedBladeAsset;
 ...
 * @author msivak
 */
public class EnchantedBladeListener extends AbstractAssetListener<EnchantedBladeAsset> {

    private static final Logger logger = LogManager.getLogger(EnchantedBladeListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        public RegisterUsableAssetListener() {
            super(EnchantedBladeListener.this);
        }
