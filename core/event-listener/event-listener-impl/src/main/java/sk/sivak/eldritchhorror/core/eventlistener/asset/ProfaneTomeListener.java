...
import sk.sivak.eldritchhorror.core.constants.asset.ProfaneTomeAsset;
 ...
 * @author msivak
 */
public class ProfaneTomeListener extends AbstractAssetListener<ProfaneTomeAsset> {

    private static final Logger logger = LogManager.getLogger(ProfaneTomeListener.class);
    ...
    private class RerollUsingAssetsListener extends AbstractAssetEventListener<TestData> {
        ...
        public RerollUsingAssetsListener() {
            super(ProfaneTomeListener.this);
        }
