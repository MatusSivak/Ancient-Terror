...
public class InternalInjuryConditionBackListener2 extends AbstractConditionBackListener {

    public InternalInjuryConditionBackListener2(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
