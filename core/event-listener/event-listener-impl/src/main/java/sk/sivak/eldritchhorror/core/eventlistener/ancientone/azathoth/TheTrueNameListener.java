...
public class TheTrueNameListener extends AbstractMysteryListener implements EventListener<AvailableEncounters>  {
    ...
    public TheTrueNameListener(MysteryCardInfo mysteryCardInfo) {
    ...
    private class EncounterActiveMysteryListener extends EventListenerImpl<MysteryEncounter> {
        ...
        public void onNotify(MysteryEncounter eventData) {
            ...
            question.setTitle("Find information about Azathoth's true name.");
