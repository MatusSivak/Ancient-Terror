...
import sk.sivak.eldritchhorror.core.constants.asset.MysticBountyHunterAsset;
 ...
 * @author msivak
 */
public class MysticBountyHunterListener extends AbstractAssetListener<MysticBountyHunterAsset> {

    private static final Logger logger = LogManager.getLogger(MysticBountyHunterListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        public RegisterUsableAssetListener() {
            super(MysticBountyHunterListener.this);
        }
