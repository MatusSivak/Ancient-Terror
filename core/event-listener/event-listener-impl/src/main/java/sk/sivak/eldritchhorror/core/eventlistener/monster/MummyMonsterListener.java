...
public class MummyMonsterListener extends AbstractMonsterListener {
    ...
    public void register(MonsterInfo monsterInfo) {
        ...
        ServicePlatform.get().getMonsterService().moveMonster(monsterInfo, LocationId.THE_PYRAMIDS);
