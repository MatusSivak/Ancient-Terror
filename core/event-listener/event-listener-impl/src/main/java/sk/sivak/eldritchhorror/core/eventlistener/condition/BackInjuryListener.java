...
import rx.Single;
import sk.sivak.eldritchhorror.core.constants.condition.backinjury.BackInjuryCondition;
...
public class BackInjuryListener extends AbstractConditionListener<BackInjuryCondition> {
    ...
    protected void register() {
        ...
        reckoningListener = new ConditionReckoningListener(BackInjuryListener.this);
