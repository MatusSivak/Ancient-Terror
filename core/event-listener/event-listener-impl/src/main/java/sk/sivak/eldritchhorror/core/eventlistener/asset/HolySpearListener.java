...
import sk.sivak.eldritchhorror.core.constants.asset.HolySpearAsset;
 ...
 * @author msivak
 */
public class HolySpearListener extends AbstractAssetListener<HolySpearAsset> {

    private static final Logger logger = LogManager.getLogger(HolySpearListener.class);
