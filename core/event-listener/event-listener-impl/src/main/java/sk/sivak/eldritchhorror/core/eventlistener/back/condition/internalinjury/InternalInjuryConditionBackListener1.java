...
public class InternalInjuryConditionBackListener1 extends AbstractConditionBackListener {

    public InternalInjuryConditionBackListener1(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
