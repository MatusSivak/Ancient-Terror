...
import sk.sivak.eldritchhorror.core.constants.artifact.CultesDesGoulesArtifact;
...
public class CultesDesGoulesListener extends AbstractArtifactListener<CultesDesGoulesArtifact> {

    private static final Logger logger = LogManager.getLogger(CultesDesGoulesListener.class);
    ...
    private class InitActionButtonListener extends EventListenerImpl<Void> {
        ...
        public String toString() {
            return "CultesDesGoulesListener - InitActionButton";
        }
    }
    ...
    private class ActionListener extends AbstractActionPhaseListener<ActionListener.CultesDesGoulesAction> {
        ...
        protected String getTexturePath() {
            return "card/artifact/CULTES_DES_GOULES.jpg";
        }
        ...
        @Override
        protected CultesDesGoulesAction createAction() {
            return new CultesDesGoulesAction();
        }
        ...
        protected class CultesDesGoulesAction extends AbstractActionPhaseAction implements CardInfoAware<CultesDesGoulesArtifact> {
            ...
            private void onCanSpend(SpendData spendData) {
                ...
                showCardRequest.setTitle("Test Lore to gain 2 Clues.");
            ...
            private void afterTest(TestData testData) {
                ...
                question.setTitle("Spend 1 Sanity to gain 2 Clues?");
            ...
            @Override
            public CultesDesGoulesArtifact getCardInfo() {
