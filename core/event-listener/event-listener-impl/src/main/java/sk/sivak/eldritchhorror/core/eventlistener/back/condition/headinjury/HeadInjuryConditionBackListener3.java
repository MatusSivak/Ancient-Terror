...
public class HeadInjuryConditionBackListener3 extends AbstractConditionBackListener {

    public HeadInjuryConditionBackListener3(ConditionInfo conditionInfo) {
        super(conditionInfo);
    }
