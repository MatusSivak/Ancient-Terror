...
import rx.Single;
import sk.sivak.eldritchhorror.core.constants.condition.internalinjury.InternalInjuryCondition;
...
public class InternalInjuryListener extends AbstractConditionListener<InternalInjuryCondition> {
    ...
    protected void register() {
        ...
        reckoningListener = new ConditionReckoningListener(InternalInjuryListener.this);
