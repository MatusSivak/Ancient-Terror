...
public abstract class AbstractAmnesiaConditionBackListener extends AbstractConditionBackListener {

    private final ConditionId conditionId;

    public AbstractAmnesiaConditionBackListener(ConditionInfo conditionInfo, ConditionId conditionId) {
        super(conditionInfo);
    ...
    protected void execute() {
        TypewriterUtils.confirmInfos("[#BAD]Gain a "+conditionId.asString()+" Condition[]",
    ...
    private void discardThisCard() {
        ...
        showCardRequest.setTitle("Discard Amnesia Condition");
