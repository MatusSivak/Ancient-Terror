...
import sk.sivak.eldritchhorror.core.constants.asset.OpusArcanaAsset;
 ...
 * @author msivak
 */
public class OpusArcanaListener extends AbstractAssetListener<OpusArcanaAsset> {

    private static final Logger logger = LogManager.getLogger(OpusArcanaListener.class);
    ...
    private class RegisterUsableAssetListener extends AbstractAssetEventListener<TestData> {
        ...
        protected Runnable getEventAction(TestData input) {
            return () -> {
                ...
                addUsableAsset(input, getAssetInfo(), amount);
            };
        }
